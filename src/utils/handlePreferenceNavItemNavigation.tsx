...
export function handlePreferenceNavItemNavigation(
    ...
    function setFocusOnPreference(newIndex: number): void {
      ...
      if (preferencePage) {
        ...
        console.warn(`No valid preference page found for preferences-nav-item-${newIndex + 1}`);
      }
    }
  
    function updatePreferenceIndex(
      prevIndex: number,
      direction: -1 | 1
    ): number {
      return (prevIndex + direction + totalPreferencePages) % totalPreferencePages; // Wrapping index calculation
    }
    ...
    switch (event.key) {
      ...
      case "Tab":
        ...
        break;
      case "Escape":
        setIsPreferencePanelOpen(); // Close the preferences panel
        break;
      default:
        break;
    }
