...
import SnappingControl from "@/components/SnappingControl/SnappingControl";
import ToolbarDivider from "@/components/Divider/ToolbarDivider";
import PlaybackMeter from "@/components/PlaybackMeter/PlaybackMeter";
...
export default function MainToolbar() {
  ...
  const transportButtons = [
    ...
    { tabIndex: -1, label: "Record", code: "\uF44A", id: "transport-button-2" },
    {
      ...
      code: "\uF448",
      id: "transport-button-3",
    },
    {
      tabIndex: -1,
      label: "Step forwards",
      code: "\uF449",
      id: "transport-button-4",
    },
  ...
  const toolButtons = [
    {
      ...
      label: "Automation",
      code: "\uF45C",
      id: "transport-button-6",
    },
    {
      tabIndex: -1,
      label: "Zoom in",
      code: "\uEF18",
      id: "transport-button-7",
    },
    {
      tabIndex: -1,
      label: "Zoom out",
      code: "\uF438",
      id: "transport-button-8",
    },
    {
      tabIndex: -1,
      label: "Fit selection to width",
      code: "\uF439",
      id: "transport-button-9",
    },
    {
      tabIndex: -1,
      label: "Fit project to width",
      code: "\uF437",
      id: "transport-button-10",
    },
    {
      tabIndex: -1,
      label: "Zoom toggle",
      code: "\uEF1F",
      id: "transport-button-11",
    },
  ...
  return (
    <div className={styles.container}>
      ...
      <SnappingControl />
      <ToolbarDivider />
      <ToolButton tabIndex={0} label="Microphone" code="&#xF41B;" id="1" />
      <PlaybackMeter />
    </div>
  );
}
